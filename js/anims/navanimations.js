...
function createHomeAnimation() {
    ...
    for (var i = homearray.length - 1; i >= 0; i--) {
      hometl.set(homepy, {attr:{src:"assets/images/homeimages/home"+homearray[i]+".png"}}, i/5);
    }
...
function createResumeAnimation() {
    ...
    for (var i = resumearray.length - 1; i >= 0; i--) {
      resumetl.set(resumejava, {attr:{src:"assets/images/resumeimages/resume"+resumearray[i]+".png"}}, i/5);
    }
...
function createPortfolioAnimation() {
    ...
    for (var i = portfolioarray.length - 1; i >= 0; i--) {
      portfoliotl.set(portfolioc, {attr:{src:"assets/images/portfolioimages/portfolio"+portfolioarray[i]+".png"}}, i/5);
    }
...
function createLinksAnimation() {
    ...
    for (var i = linksarray.length - 1; i >= 0; i--) {
      linkstl.set(linkshtml, {attr:{src:"assets/images/linksimages/links"+linksarray[i]+".png"}}, i/5);
    }
