...
// Create All Nav Hover Animations
...
function createHomeAnimation() {
    ...
    for (var i = homearray.length - 1; i >= 0; i--) {
      hometl.set(homepy, {attr:{src:'/homeimages/home'+homearray[i]+'.svg'}}, i/5);
    }
...
function createResumeAnimation() {
    ...
    for (var i = resumearray.length - 1; i >= 0; i--) {
      resumetl.set(resumejava, {attr:{src:'/resumeimages/resume'+resumearray[i]+'.svg'}}, i/5);
    }
...
function createPortfolioAnimation() {
    ...
    for (var i = portfolioarray.length - 1; i >= 0; i--) {
      portfoliotl.set(portfolioc, {attr:{src:'/portfolioimages/portfolio'+portfolioarray[i]+'.svg'}}, i/5);
    }
...
function createLinksAnimation() {
    ...
    for (var i = linksarray.length - 1; i >= 0; i--) {
      linkstl.set(linkshtml, {attr:{src:'/linksimages/links'+linksarray[i]+'.svg'}}, i/5);
    }
